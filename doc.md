...
* **Prize:** "Your custom Service or EVVM Chain" ($5,000)  
...
* **Prize:** "Connect the World with Chainlink" ($6,000)  
...
npx evvm-admin add-executor \--chain 0xMyCustomChain \--address $EXCHANGE\_ADMIN  
npx evvm-admin add-executor \--chain 0xMyCustomChain \--address $CHAINLINK\_ADAPTER

### **3\. Deploy Logic & Run Auditor**

forge create \--rpc-url $VPOR\_CHAIN\_RPC src/GlassVault.sol:GlassVault  
npx hardhat functions-simulate \--script ./verify\_assets.js  
